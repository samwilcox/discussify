...
/**
 * Caching class that caches data using MySQL's caching abilities.
 * 
 * @package Discussify\Data\Cache
 */
class SqlCache extends \Discussify\Data\Cache\DataCache implements \Discussify\Data\CacheStructure {
    /**
    ...
    public static function getCache($table, $sorting) {
        return self::db()->query(self::queries()->selectForCacheCached(['table' => $table, 'sorting' => $sorting]));
    } 
